...
public class Utilities {
																...
																if (standard.equals("java")) {
																	...
																	if (standard.equals("javax")) {
																		...
																		if (standard.equals("isJavaClass"))
																			...
																			if (standard.equals("isJavaObject"))
																				...
																				if (standard.equals("isJavaPackage"))
																					...
																					if (standard.equals("print"))
																						...
																						if (standard.equals("eval"))
																							...
																							if (standard.equals("importClass"))
	...
	public static BaseObject get(BaseObject _this, BaseObject key) {
		if (key instanceof String.Instance)
			...
			if (key instanceof Number.Instance && ((Number.Instance) key).value >= 0
