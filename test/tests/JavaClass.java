...
public class JavaClass {
	...
	public void test(java.lang.String name) {
		for(Compiler compiler : compilers) {
			try {
				compiler.compile(new InputStreamReader(JavaClass.class.getResourceAsStream("/tests/javaclass/" + name + ".js")), name + ".js", false).exec(JSHelper.createExtendedGlobal(), null);
