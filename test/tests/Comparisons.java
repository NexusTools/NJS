...
public class Comparisons {
	...
	public void test(java.lang.String name) {
		for(Compiler compiler : compilers) {
			try {
				compiler.compile(new InputStreamReader(Comparisons.class.getResourceAsStream("/tests/comparisons/" + name + ".js")), name + ".js", false).exec(Utilities.createExtendedGlobal(), null);
